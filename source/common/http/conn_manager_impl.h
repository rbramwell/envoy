...
private:
  ...
  struct ActiveStream : LinkedObject<ActiveStream>,
    ...
    struct FilterCallState {
      static constexpr uint32_t DecodeHeaders = 0x1;
      static constexpr uint32_t DecodeData = 0x2;
      static constexpr uint32_t DecodeTrailers = 0x4;
      static constexpr uint32_t EncodeHeaders = 0x8;
